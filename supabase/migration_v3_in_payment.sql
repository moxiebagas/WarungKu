-- =============================================================
-- v3: store payment_method for IN (purchase) transactions too,
-- not just OUT (sales). Run once after migration_payments.sql.
-- Safe to re-run.
-- =============================================================

drop function if exists execute_stock_movement(uuid, text, numeric, text, text, text, text, text);
...
begin
  ...
  if p_movement_type = 'IN' then
    ...
    v_payment := p_payment_method; -- purchase payment method (may be null)
